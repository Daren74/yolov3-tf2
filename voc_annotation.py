...
#               'train', 'tvmonitor']
    classes = ['emoticon', 'logo_corp', 'sticker']
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_annotation", default="D:\\Projects\\python\\YOLO\\data\\dataset\\psmc_train.txt")
    parser.add_argument("--test_annotation",  default="D:\\Projects\\python\\YOLO\\data\\dataset\\psmc_train.txt")
...
#    num3 = convert_voc_annotation(os.path.join(flags.data_path, 'test/VOCdevkit/VOC2007'),  'test', flags.test_annotation, False)
    num1 = convert_voc_annotation(os.path.join(flags.data_path, 'D:\Projects\python\YOLO\data'), 'psmc_train_file', flags.train_annotation, False)
    num3 = convert_voc_annotation(os.path.join(flags.data_path, 'D:\Projects\python\YOLO\data'),  'psmc_train_file', flags.test_annotation, False)
